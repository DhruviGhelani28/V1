...
const Footer = (props)=> {
    return (
        <React.Fragment>
            ...
            {/* // <FooterContainer > */}
         <footer style={{ width: '100%',height: 0, marginLeft: 0.1, marginRight: 0.1, position: "absolute", bottom: 0, verticalAlign: 'bottom', padding: 0 }}> 

            <Box sx={{ background: 'linear-gradient(45deg,#434344 5%,#575758 20%)', px: { xs: 1, sm: 8 }, py: { xs: 3, sm: 5 }, width: '100%',height: 'fit-content', color: 'white', padding: 0 }}>
                <Container > 
